# -*- coding: utf-8 -*-
"""
Created on Mon Nov 27 20:49:05 2023

@author: akbar
"""

#################################################################################################################
'Homework_3(Crank_Nicolson algorithm to solve time dependent schrödinger equation)'
#################################################################################################################
...
for i in nx:
        alpha = (2*(dx**2))/(tau*D) + 2 + ((1j*(dx**2)*V(i, height, v, potential_well_width, w=10))/D)
        alpha_values.append(alpha)
        beta = (2*(dx**2))/(tau*D) - 2 - ((1j*(dx**2)*V(i, height, v, potential_well_width, w=10))/D)
